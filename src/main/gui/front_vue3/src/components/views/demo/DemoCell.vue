<template>
    <div class="demo-cell">
        <div class="card">
            ...
            <div class="p-2">
                <img class="card-img-top rounded" :src="book.headerImg" alt="">
            </div></a>
            <div class="card-body pt-2">
                ...
                <Tag v-if="book.support">优质</Tag>
                <!--<p class="operate_info">
                    <span class="readings">
                                 <Icon type="ios-eye"/> {{book.click}}
                        </span>
                    <span class="comments">
                                <Icon type="ios-create"/> {{book.commentCount}}
                        </span>
                    <span class="likes">
                            <a @click="likePost(book)">
                                <Icon type="ios-heart"/> {{book.like}}
                            </a>
                        </span>
                </p>-->
                <p class="desc">
                    {{book.summary | textLineBreak(90) }}
                </p>
                <div class="tags">
                ...
                <p class="text-muted small mb-2">Last updated: {{ book.createTime | socialDate }}</p>
