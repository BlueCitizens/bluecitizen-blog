<template>
    <div class="essay-home-content layout-content">
        <Row>
            <Col :xs="24" :sm="24" :md="24" :lg="17">
                <div class="layout-left">
                    <ClassifyMenu v-if="categories !=null " :categories="categoriesInfo"
                                  :defaultCategoryId="selected_category" :type-id="typeId"
...
<script type="text/ecmascript-6">
    ...
    export default {
        name: 'EssayHomeContent',
        components: {
            ClassifyMenu, ArticleListCell, SectionTitle, BrowseMore, Recommend, Hot, TagWall
        },
        data() {
            return {
                typeId: 2,
