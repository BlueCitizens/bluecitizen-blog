...
export function searchBlogInfo(query){
    return request({
        url:'/f/search',
        method: 'get',
        params: query
...
// 查询随笔列表
export function listEssayBaseInfo(query) {
    return request({
        url: '/f/blog',
        method: 'get',
        params: query
...
//获取格里芬人形数据
export function listDollInfo(query) {
    return request({
        url: '/f/grifon/build',
        method: 'get',
        params: query
...
export function allDollName(query) {
    return request({
        url: '/f/grifon/all/name',
        method: 'get',
        params: query
    })
}
