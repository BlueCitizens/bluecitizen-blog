<template>
    <div class="social-section card card-body" id="comments" v-if="pageId !== undefined" ref="socialSection">
        <Spin size="large" v-if="!allowComment" fix style="z-index: 1;"><Slot></Slot></Spin>
