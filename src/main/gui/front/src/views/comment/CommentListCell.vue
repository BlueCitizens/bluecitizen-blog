                ...
                <div class="comment-main">
                  ...
                  <span class="name">
                    ...
                    <a>{{ comment.replyNickName }}</a>
                                    ...
                                    <span class="name-tag"
                                          v-if="comment.replyNickName != undefined && comment.adminReply==true">BC君</span>
                                ...
                                <div class="operate-area">
                                  <span class="like" @click="likeComment(comment)" title="点赞">
                                   <a>
                                     <Icon type="md-thumbs-up" />  {{ comment.good }}
                                   </a>
                                  </span>
                                    <span class="unlike" @click="unlikeComment(comment)" title="踩">
                                 <a>
                                     <Icon type="md-thumbs-down" />    {{ comment.bad }}
                                   </a>
                                     </span>
                                    <span class="reply">
