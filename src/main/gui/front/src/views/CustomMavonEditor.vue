<template>
    <div class="custom-mavon-editor">
            ...
            <Form>
                <Row>
                    <Col :xs="10" :sm="10" :md="10" :lg="10" style="padding-left: 0; padding-right: 7.5px;">
                        <Input placeholder="QQ" v-model="form.qqNum" clearable @on-blur="getInfoByQQ"
                               size="default">
                    ...
                    <Col :xs="10" :sm="10" :md="10" :lg="10">
                        <Input v-model="form.nickName" placeholder="展示的名字" size="default">
                ...
                <Row>
                    <Col :xs="10" :sm="10" :md="10" :lg="10" style="padding-left: 0; padding-right: 7.5px;">
                        <Input v-model="form.email" placeholder="邮箱" size="default">
                            <span slot="prepend">邮箱</span>
                        </Input>
                    </Col>
                    <Col :xs="6" :sm="6" :md="6" :lg="6">
                        <Checkbox v-model="form.reply" style=" margin: 5% 8%;">接收通知</Checkbox>
                    </Col>
                    <Col :xs="8" :sm="8" :md="8" :lg="8">
                        <span style="font-size: 12px"><i class="fa fa-bell-o"></i> 可输入QQ号后点框外自动填充</span>
                    </Col>
                </Row>
            </Form>
        </div>
        ...
        <div class="editor-area">
            <Spin size="large" v-if="!allowComment" fix style="z-index: 99;">
                评论已关闭
            </Spin>
            <mavon-editor v-model="form.content"
                          v-if="showEditor"
                          :autofocus="false"
                          style="height: 100%; min-height: 50px; min-width: 200px; z-index: 98;"
                          :codeStyle="codeStyle"
        ...
        <div class="bottom-area">
            ...
            <div class="publish-area">
                <Button :ghost="false" size="default" :type="buttonType" :loading="publishing" @click="send"
                        :disabled="!allowComment">
                    <span v-if="!publishing"><Icon size="20" type="md-paper-plane" />发送</span>
...
<script type="text/ecmascript-6">
    ...
    export default {
        ...
        computed: {
            ...
            buttonType: function () {
                return this.siteTheme === 'dark' ? 'warning' : 'default';
            },
            codeStyle: {
                get: function () {
