<template>
    <div class="article-content layout-content" v-if="article">
        <Row>
            <Col :xs="24" :sm="24" :md="24" :lg="ExpandLeftColumn ? 24 : 17" class="card card-body">
                        ...
                        <div class="article-details" id="article-main-page" slot="content" ref="article">
                            <div class="detail" v-if="article">
                                ...
                                <div class="detail-footer" v-if="article.updateTime !=null">
                                    created on {{ article.createTime | socialDate }} &nbsp;&nbsp;&nbsp;/
                                    updated on {{ article.updateTime | socialDate }}
                                </div>
                                <div class="detail-footer" v-if="article.updateTime ==null">
                                    created on {{ article.createTime | socialDate }} &nbsp;&nbsp;&nbsp;
                                </div>
            ...
            <Col :xs="0" :sm="0" :md="0" :lg="ExpandLeftColumn ? 0 : 7">
                <div class="layout-right">
                    <About style="margin:0 15px 15px 15px"></About>
                    <!--<Affix offset-top="60">
                        <side-toc ref="sideToc" style="margin:0 15px 15px 15px"></side-toc>
                    </Affix>-->
                    <recommend style="margin:0 15px 15px 15px"/>
                    <hot style="margin:0 15px 15px 15px"/>
                </div>
            </Col>
        </Row>
    </div>
...
<script type="text/ecmascript-6">
    ...
    export default {
        ...
        methods: {
            ...
            // 更新目录
            refreshContent() {
                document.title = this.article.title + " | BlueCity";
