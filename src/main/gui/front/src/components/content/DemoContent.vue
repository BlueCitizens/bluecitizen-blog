        ...
        <Row>
            <Col :xs="24" :sm="24" :md="24" :lg="17">
                <div class="layout-left">
                    <div class="card card-body">
                        <GrifonContent></GrifonContent>
                    </div>
                    <div class="hot card card-body">
                        <div class="book-infos">
                            <div class="book-base-info">
                                ...
                                <div class="info">
                                    ...
                                    <p class="desc"><span>开发者：</span>{{ book.author }}</p>
                                    <p class="desc"><span>开源仓库：</span>{{ book.publisher }}</p>
                                    <p class="desc"><span>上架日期：</span>{{ book.publishDate }}</p>
                                    <p class="desc"><span></span>
                                        <Progress :percent="book.progress" :stroke-width="20"
                                                  :stroke-color="['#108ee9', '#87d068']" status="active"
                                                  text-inside/>
                                    </p>
                                    <p class="desc"><span>评分：</span>
                                        <Rate v-model="book.grade" :allowHalf="true"
                                              :disabled="true"></Rate>
                                    </p>
                            ...
                            <vue-tabs class="book-detail-info" @tab-change="handleTabChange">
                                ...
                                <v-tab title="读后感" v-if="book !== undefined">
                                    ...
                                    &lt;!&ndash;<p class="summary" v-html="book.detail.formatted_content"></p>&ndash;&gt;
                                </v-tab>-->
                            </vue-tabs>
                        </div>
                    </div>
            ...
            <Col :xs="0" :sm="0" :md="0" :lg="7">
                <div class="layout-right">
                    ...
                    <div class="hot card card-body" style="margin:0 15px 15px 15px">
                        <div class="book-infos">
                            <div class="book-base-info">
                                <!--<div class="img">
                                    <div class="container">
                                ...
                                <div class="info">
                                    <p class="title">{{book.title}}</p>
                                    <p class="desc"><span>开发者：</span>{{ book.author }}</p>
                                    <p class="desc"><span>开源地址：</span>{{ book.publisher }}</p>
                                    <p class="desc"><span>上架日期：</span>{{ book.publishDate }}</p>
                                    <p class="desc"><span></span>
                                        <Progress :percent="book.progress" :stroke-width="20"
                                                  :stroke-color="['#108ee9', '#87d068']" status="active"
...
<script type="text/ecmascript-6">
    ...
    import GrifonContent from "../../views/demo/GrifonContent";
    ...
    export default {
        ...
        methods: {
            ...
            refreshData() {
                ...
                console.log("refresh dta" + this.id);
            },
