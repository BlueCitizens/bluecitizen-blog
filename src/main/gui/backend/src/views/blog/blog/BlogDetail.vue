            ...
            <el-col :span="18">
              ...
              <el-row>
                ...
                <el-col :span="4">
                  ...
                  <el-form-item label-width="60px" label="原创: " class="postInfo-container-item" prop="original">
                    <el-switch v-model="form.original" active-color="#13ce66" inactive-color="#ff4949"></el-switch>
                  </el-form-item>
                </el-col>
                <el-col :span="6">
                  ...
                  <el-col :span="16">
                    <el-form-item label-width="60px" label="标签: " prop="tagTitleList">
                      <el-select
                        ...
                        :loading="loading"
                        :remote-method="getRemoteTagList" allow-create placeholder="文章标签">
